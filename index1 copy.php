            ...
            <tbody>
                <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
                    <tr>
                        ...
                        <td><button type="button" class="btn btn-secondary btn-sm rechnungBtn" data-kundennr="<?php echo $row['kundenNr']; ?>">Neue Rechnung</button></td>
...
$(document).ready(function() {
    $('.rechnungBtn').click(function() {
        var kundennr = $(this).data('kundennr'); // Kundennr aus dem Button-Datensatz holen
